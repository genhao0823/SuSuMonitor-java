...
public interface CommandRunMapper {
    ...
    List<CommandRunEntity> selectRuns(@Param("serverId") Long serverId, @Param("status") String status,
            @Param("offset") long offset, @Param("pageSize") int pageSize);

    /** 统计查询总数。 */
    long countRuns(@Param("serverId") Long serverId, @Param("status") String status);
