...
object ErrorCodes {
    ...
    const val COMMAND_PARAM_INVALID = 40004
    ...
    const val COMMAND_RUN_STATE_CONFLICT = 40905
    const val COMMAND_AGENT_OFFLINE = 40906
    ...
    const val LOGIN_RATE_LIMIT_REACHED = 42905
    const val AI_RATE_LIMIT_REACHED = 42906
    const val COMMAND_RATE_LIMIT_REACHED = 42907
    ...
    const val REDIS_UNAVAILABLE = 50302
    const val AI_PROVIDER_UNAVAILABLE = 50303
    const val AI_DIAGNOSIS_UNAVAILABLE = 50304
    const val AI_PROVIDER_RESPONSE_INVALID = 50305
    const val SSH_CONNECTION_TIMEOUT = 50400
    const val AI_PROVIDER_TIMEOUT = 50401
    const val COMMAND_EXECUTION_TIMEOUT = 50402
}
