...
| 当前基线 | `main @ d8eb375`（2026-09-05；AI 命令域 M1 + F1 告警智能解释 + Android 终端手势修复收口提交；HEAD 与 `origin/main` 一致，工作区干净） |
