...
| 当前基线 | `main @ 9c9c387`（2026-09-15；M2 观察期评审报告前后端实现提交，docs 收口随本批次提交；期间已并入进程级监控 9be01d1、安全加固与全功能联调 0914 批次） |
